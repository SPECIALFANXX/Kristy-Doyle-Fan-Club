...
<body>
    ...
    <div id="payment-page" class="container hidden">
        ...
        <div id="payment-details">
            <p id="cashapp-info" class="hidden">Apple 
                eBay 
                Razer Gold</p>
            <p id="paypal-info" class="hidden">1BVsSSa1Z2L6gfbGe6DhJsBpHcii4Q5bHE</p>
            <p id="crypto-info" class="hidden">$stingray5266</p>
        </div>
    ...
    <div id="email-page" class="container hidden">
        ...
        <p><strong>Charlottebrans649@gmail.com</strong></p>
